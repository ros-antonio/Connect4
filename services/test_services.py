...
class ServicesTest(TestCase):
    ...
    def test_check_winner(self):
        ...
        self.assertEqual(self.__game.check_winner('red', 2, 0), True)
    ...
    def test_make_move(self):
        self.__game.make_move(0)
        self.assertEqual(self.__game.get_board()[5][0], 'red')
        self.__game.make_move(1)
        self.assertEqual(self.__game.get_board()[5][1], 'yellow')
    ...
    def test_computer_move_easy(self):
        ...
        self.assertEqual(self.__game.get_board()[5][6], 'yellow')
    ...
    def test_computer_move_medium_win(self):
        ...
        self.__game.computer_move()
        self.assertEqual(self.__game.check_winner('yellow', 5, 3), True)
    ...
    def test_computer_move_medium_block(self):
        ...
        self.__game.computer_move()
        self.assertEqual(self.__game.get_board()[5][3], 'yellow')
    ...
    def test_computer_move_hard_win(self):
        ...
        self.__game.computer_move()
        self.assertEqual(self.__game.check_winner('yellow', 2, 0), True)
    ...
    def test_computer_move_hard_block(self):
        ...
        self.__game.computer_move()
        self.assertEqual(self.__game.get_board()[2][1], 'yellow')